...
bureaucracytype <- read.csv("data/bureaurcarytype.csv") %>%
  clean_names()

reservationproportion <- read.csv("data/reservationproportion.csv") %>%
  clean_names()

levelhistory <- read.csv("data/levelhistory.csv") %>%
  clean_names()

levelrecent <- read.csv("data/levelrecent.csv") %>%
  clean_names()

trend <- read.csv("data/trend2007to2018.csv") %>%
  clean_names()
